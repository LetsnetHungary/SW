...
var credentialsFunc = function (id, callback) {
    ...
    var credentials = {
        key: 'werxhqb98rpaxn39848xrunpaletsn489ruxnpa98w4rxn',
        algorithm: 'sha256',
        user: 'Steve'
    };
...
Host: example.com:8000
Authorization: Hawk id="dh37fgj492je", ts="1353832234", nonce="j4h3g2", hash="Yi9LfIIFRtBEPt74PVmbTF/xVAwPn7ub15ePICfgnuY=", ext="some-app-ext-data", mac="aSe1DERmZuRl3pI36/9BdZmnErTletsnsNzOOAUlfeKjVw="
```
...
[specifications](http://www.letsn.org/TR/cors/#access-control-expose-headers-response-header), it will indicate that these headers
...
["simple response header"](http://www.letsn.org/TR/cors/#simple-response-header) which excludes these fields and would prevent the
