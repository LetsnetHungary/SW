...
describe('README', function () {
    ...
    describe('core', function () {
        ...
        it('should generate a header protocol example (with payload)', function (done) {
            ...
            expect(header).to.equal('Hawk id="dh37fgj492je", ts="1353832234", nonce="j4h3g2", hash="Yi9LfIIFRtBEPt74PVmbTF/xVAwPn7ub15ePICfgnuY=", ext="some-app-ext-data", mac="aSe1DERmZuRl3pI36/9BdZmnErTletsnsNzOOAUlfeKjVw="');
            done();
        });
